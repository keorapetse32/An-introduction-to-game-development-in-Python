...
wood_bg = pygame.image.load('image/Wood_BG.png')
land_bg = pygame.image.load('image/Land_BG.png')
water_bg = pygame.image.load('image/Water_BG.png')
cloud1 = pygame.image.load('image/Cloud1.png')
cloud2 = pygame.image.load('image/Cloud2.png')
crosshair = pygame.image.load('image/crosshair.png')
duck_surface = pygame.image.load('image/duck.png')
